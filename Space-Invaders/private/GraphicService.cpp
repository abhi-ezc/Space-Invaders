...
void GraphicService::update() { gameWindow->clear(windowColor); }

void GraphicService::render() { gameWindow->display(); }
...
void GraphicService::draw(sf::Drawable& drawable) { gameWindow->draw(drawable); }

#pragma endregion

#pragma region Getter Functions

sf::RenderWindow* GraphicService::getGameWindow() { return gameWindow; }

void GraphicService::closeGameWindow() { gameWindow->close(); }
